...
namespace MscrmTools.EnvironmentVariableManager
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
     ExportMetadata("Name", "Environment Variables Manager"),
     ExportMetadata("Description", "Updates your environment variables easily"),
    ...
    public class EvmPlugin : PluginBase, IPayPalPlugin
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new EvmControl();
        }
